    ...
    <section class="index_section row vh-100">
        <nav class="navHome d-flex flex-column flex-shrink-0 bg-light p-0 border-end" style="width: 4.5rem">
            ...
            <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                ...
                <li class="option">
                    <a href="./add.php" class="option_container nav-link py-3 border-bottom rounded-0 link-dark" data-bs-toggle="tooltip" data-bs-placement="right" title="Proveedores">
                        <iconify-icon class="iconify" icon="fa-solid:users" width="30" height="30"></iconify-icon>
                    </a>
                </li>
                <li class="option">
                    <a href="../empleados/read.php" class="option_container nav-link active py-3 border-bottom rounded-0 bg-dark" data-bs-toggle="tooltip" data-bs-placement="right" title="Empleados">
        ...
        <section class="main_container col-lg-11">
            <ul class="nav nav-tabs mt-4">
                ...
                <li class="nav-item">
                    <a href="./add.php" class="nav-link active">Borrar Usuario</a>
                </li>
            </ul>
            <main class="dashboard_container container">
                ...
                <div class="row">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 ">
                            <select name="sexo" id="sexo" class="form-select" required disabled>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 ">
                            <select name="usuario-rol" id="rol" class="form-select" required disabled>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h5>¿Estás seguro de borrar este usuario?</h5>
