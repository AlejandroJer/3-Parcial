...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-11-2023 a las 06:26:17
...
--
ALTER TABLE `respaldo_producto`
  MODIFY `id_producto_r` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `id_usr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
COMMIT;
