...
namespace controladores;
 ...
 if(isset($_SESSION['results']) && isset($_SESSION['filters'])){
    ...
    $index = $_SESSION['index'];
    $page = $_SESSION['pageClicked'];
    // echo "<script>console.log('".$filters['cantidadMenig']."');</script>";
 }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <section class="main_container col-lg-11 bg-light">
            ...
            <div class="read_header my-4">
                <form method="POST" action="../controladores/gets/SearchProducto.php" class="search_bar input-group">
                    <!-- BTN MODAL -->
                    <button type="button" name="filter" id="filter" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-filter">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary">
                        <iconify-icon icon="ic:sharp-content-paste-search" width="30" height="30"></iconify-icon>
                    </button>
                </form>
                <!-- FILTER MODAL -->
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input list="datalist-proveedores" name="filter-search-proov" id="filter-search-proov" placeholder="Buscar Proveedor" class="form-control border-dark px-2 border-start-0 rounded-end">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" list="datalist-ubicaciones" name="filter-search-Ubi" id="filter-search-Ubi" placeholder="Buscar Ubicacion" class="form-control border-dark px-2 border-start-0 rounded-end">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="row">
                                                <?php foreach($materialesResult as $material) { ?>
                                                    <div class="col-auto">
                                                        <input type="checkbox" name="filter-materials[]" value="<?= $material ?>" id="<?= $material ?>" class="btn-check materials-check" autocomplete="off" onclick="checkAll('materials-check', 'All-Materials')">
                                                        <label for="<?= $material ?>" class="btn btn-outline-secondary btn-sm"><?= $material ?></label>
                                                    </div>
                                                <?php } ?>
                                                <div class="col-auto">
                                                    <input type="checkbox" name="filter-materials[]" value="all" id="All-Materials" class="btn-check" autocomplete="off" checked disable>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <?php foreach($categoriasResult as $categoria) { ?>
                                                    <div class="col-auto">
                                                        <input type="checkbox" name="filter-categorias[]" value="<?= $categoria ?>" id="<?= $categoria ?>" class="btn-check categories-check" autocomplete="off" onclick="checkAll('categories-check', 'All-Categorias')">
                                                        <label for="<?= $categoria ?>" class="btn btn-outline-secondary btn-sm"><?= $categoria ?></label>
                                                    </div>
                                                <?php } ?>
                                                <div class="col-auto">
                                                    <input type="checkbox" name="filter-categorias[]" value="all" id="All-Categorias" class="btn-check" autocomplete="off" checked disable>
                                    ...
                                    <div>
                                        <div class="row mb-4">
                                            ...
                                            <div class="row collapse" id="filter-peso-inputs">
                                                <div class="col-lg-6">
                                                    <div class="input-group col-lg-6">
                                                        <span class="input-group-text">menor a</span>
                                                        <input type="number" min="0" step="0.01"  class="form-control" name="filter-peso-menig" id="filter-peso-menig" placeholder="Gramos" oninput="checkInput('filter-peso-mayig',event)">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-group col-lg-6">
                                                        ...
                                                        <input type="number" min="0" step="0.01"  class="form-control" name="filter-peso-mayig" id="filter-peso-mayig" placeholder="Gramos" oninput="checkInput('filter-peso-menig',event)">
                                                        <span class="input-group-text">gr</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="row collapse" id="filter-cantidad-inputs">
                                                <div class="col-lg-6">
                                                    <div class="input-group col-lg-6">
                                                        <span class="input-group-text">menor a</span>
                                                        <input type="number" min="0"  class="form-control" name="filter-cantidad-menig" id="filter-cantidad-menig" placeholder="Cantidad" oninput="checkInput('filter-cantidad-mayig',event)">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-group col-lg-6">
                                                        <span class="input-group-text">mayor a</span>
                                                        <input type="number" min="0"  class="form-control" name="filter-cantidad-mayig" id="filter-cantidad-mayig" placeholder="Cantidad" oninput="checkInput('filter-cantidad-menig',event)">
                                                        <span class="input-group-text">en existencia</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="row collapse" id="filter-precioCompra-inputs">
                                                <div class="col-lg-6">
                                                    <div class="input-group col-lg-6">
                                                        <span class="input-group-text">menor a $</span>
                                                        <input type="number" min="0" step="0.01"  class="form-control" name="filter-precioCompra-menig" id="filter-precioCompra-menig" placeholder="mayor que" oninput="checkInput('filter-precioCompra-mayig',event)">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-group col-lg-6">
                                                        <span class="input-group-text">mayor a $</span>
                                                        <input type="number" min="0" step="0.01"  class="form-control" name="filter-precioCompra-mayig" id="filter-precioCompra-mayig" placeholder="pesos" oninput="checkInput('filter-precioCompra-menig',event)">
                                                        <span class="input-group-text">MX</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="row collapse" id="filter-precioVenta-inputs">
                                                <div class="col-lg-6">
                                                    <div class="input-group col-lg-6">
                                                        <span class="input-group-text">menor a $</span>
                                                        <input type="number" min="0" step="0.01"  class="form-control" name="filter-precioVenta-menig" id="filter-precioVenta-menig" placeholder="mayor que" oninput="checkInput('filter-precioVenta-mayig',event)">
                                                        <span class="input-group-text">MX</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="input-group col-lg-6">
                                                        <span class="input-group-text">mayor a $</span>
                                                        <input type="number" min="0" step="0.01"  class="form-control" name="filter-precioVenta-mayig" id="filter-precioVenta-mayig" placeholder="pesos" oninput="checkInput('filter-precioVenta-menig',event)">
                                                        <span class="input-group-text">MX</span>
                                                    </div>
                                                </div>
                                            </div>
